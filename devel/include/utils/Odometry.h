...
struct Odometry_
{
  ...
  _angular_velocity_type angular_velocity;
   ...
   typedef  ::geometry_msgs::Vector3_<ContainerAllocator>  _YPY_type;
  _YPY_type YPY;
...
struct MD5Sum< ::utils::Odometry_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xfc870a8e2d3ea437ULL;
  static const uint64_t static_value2 = 0xc6c672a95e3ca877ULL;
};
...
struct Printer< ::utils::Odometry_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::utils::Odometry_<ContainerAllocator>& v)
  {
    ...
    s << indent << "YPY: ";
    s << std::endl;
    Printer< ::geometry_msgs::Vector3_<ContainerAllocator> >::stream(s, indent + "  ", v.YPY);
